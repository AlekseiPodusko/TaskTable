...
public class LoginServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        user.setSureName("Podusko");
        user.setPhone("+37255627726");
        user.setLogin("admin");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(path) {
            ...
            case "/login":
                ...
                request.setAttribute("info", "Welcome " + authUser.getFirstName());
            ...
            case "/logout":
                ...
                if (session != null) {
                    ...
                    if (isPasswordChanged != null && isPasswordChanged.equals("true")) {
                        request.setAttribute("info", "The password has been changed. Log in again.");
                    } else {
                        request.setAttribute("info", "You are log out");
                    }
                }
                request.getRequestDispatcher("/showLogin").forward(request, response);
                break;
            ...
            case "/registration":
                ...
                if (!password1.equals(password2)) {
                    ...
                    request.setAttribute("info", "Password mismatch");
                ...
                if(role == null){
                    request.setAttribute("info", "Can't find the role");
                    request.getRequestDispatcher("/showRegistration").forward(request, response);
                    break;
                }
                UserRoles ur = new UserRoles();
                ...
                ur.setUser(newUser);
                userRolesFacade.create(ur);
                request.setAttribute("info", "Hello, "+newUser.getFirstName()+"! Log in");
                request.getRequestDispatcher("/showLogin").forward(request, response);
                break;
        }
