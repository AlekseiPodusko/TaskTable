...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="/listTasks">TaskTable</a>
            ...
            <ul class="navbar-nav me-auto">
                <c:choose>
                    <c:when test="${topRole eq 'ADMINISTRATOR'}">
                        ...
                        <li class="btn-sm btn-success my-1 mx-1 mb-1 mt-1"><a class="nav-link" href="showAddTask">Add Task</a></li>
                        <li class="btn-sm btn-success my-1 mx-1 mb-1 mt-1"><a class="nav-link" href="listTasks">Task List</a></li>
                        <li class="btn-sm btn-success my-1 mx-1 mb-1 mt-1"><a class="nav-link" href="showEditUser">Edit Personal Data</a></li>
